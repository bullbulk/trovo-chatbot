...
pub struct ChatMessage {
    ...
    // The list of role of the message sender which is a json string.
    // Different from "roles", "custom_role" contains more information.
    // However, if you just need the role names, use "roles" instead.
